...
public class ServicesResourceIntTest {
    ...
    private static final Instant DEFAULT_TIME_APROX = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_TIME_APROX = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public void createServices() throws Exception {
        ...
        assertThat(testServices.getTimeAprox()).isEqualTo(DEFAULT_TIME_APROX);
    }
    ...
    public void getAllServices() throws Exception {
        ...
        restServicesMockMvc.perform(get("/api/services?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].timeAprox").value(hasItem(DEFAULT_TIME_APROX.toString())));
    }
    ...
    public void getServices() throws Exception {
        ...
        restServicesMockMvc.perform(get("/api/services/{id}", services.getId()))
            ...
            .andExpect(jsonPath("$.timeAprox").value(DEFAULT_TIME_APROX.toString()));
    }
    ...
    public void updateServices() throws Exception {
        ...
        assertThat(testServices.getTimeAprox()).isEqualTo(UPDATED_TIME_APROX);
    }
